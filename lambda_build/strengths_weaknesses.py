...
def analyze_strengths_weaknesses(game_name, tagline, region):
    try:
        ...
        # ... (averages, scores, and return unchanged)
    except Exception as e:
        print(f"Overall error: {str(e)}")
        return {"error": str(e), "scores": {}}  # Fallback dict
