                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="flex-1 p-8">
                    <div className="flex items-center gap-4 mb-6">
                      <h3 className="text-4xl font-black text-foreground">{champion.name}</h3>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                      <div>
                        ...
                        <div className="text-2xl font-bold text-primary">{champion.points}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground mb-1">Games Played</div>
                        <div className="text-2xl font-bold text-secondary">{champion.games}</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground mb-1">Win Rate</div>
                        <div className="text-2xl font-bold text-accent">{champion.winRate}%</div>
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground mb-1">KDA</div>
                        <div className="text-2xl font-bold text-foreground">{champion.kda}</div>
                      </div>
                    </div>
                  </div>
                </div>
