...
def lambda_handler(event, context):
    ...
    if action_group != 'SocialComparisonsActionGroup':
        print("Invalid action group")
        return format_response(400, {'error': 'Invalid action group, expected "SocialComparisonsActionGroup"'}, action_group, api_path, http_method, event)
